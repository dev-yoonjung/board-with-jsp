		...
		<div class="container">
			<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
							<th style="background-color: #eeeeee; text-align: center;">번호</td>
							<th style="background-color: #eeeeee; text-align: center;">제목</td>
							<th style="background-color: #eeeeee; text-align: center;">작성자</td>
							<th style="background-color: #eeeeee; text-align: center;">작성일</td>
						</tr>
					</thead>
					<tbody>
						<tr>
